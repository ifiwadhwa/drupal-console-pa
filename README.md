# drupal-console-pa
DrupalConsole Punjabi Language / ਪੰਜਾਬੀ ਭਾਸ਼ਾ
...
```
$ composer require drupal/console-pa
```
...
- Fork this repository following this link [https://github.com/hechoendrupal/drupal-console-pa#fork-destination-box](https://github.com/hechoendrupal/drupal-console-pa#fork-destination-box)
...
```
$ git remote add upstream git@github.com:hechoendrupal/drupal-console-pa.git
```
